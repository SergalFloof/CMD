 ...
 @Mod(modid="cmd", version="1.10.0", acceptedMinecraftVersions="[1.9.4]")
 public class CMD
 {
   @net.minecraftforge.fml.common.SidedProxy(clientSide="cmd.client.CMDClientProxy", serverSide="cmd.common.CMDCommonProxy")
